...
class DatabaseSearchIntegration:
    ...
    def __init__(self, parent_window):
        ...
        self.table_mapping = {
            ...
            'jlce': ('LNK/JL', 'LNK_table', None, 'id', ['Source_Name', 'Local_Path', 'Common_Path', 'Relative_Path']),
            'custom_jlce': ('LNK/JL', 'AJL_table', None, 'id', ['Source_Name', 'Local_Path_Ext', 'CLI_Arguments']),
