...
class DatabaseSearchIntegration:
    ...
    def __init__(self, parent_window):
        ...
        self.table_mapping = {
            ...
            'lnk_files': ('LNK/JL', 'LNK_table', None, 'id', ['file_name', 'target_path', 'lnk_path', 'Source_Name', 'Local_Path']),
            'LNK_table': ('LNK/JL', 'LNK_table', None, 'id', ['file_name', 'target_path', 'Source_Name']),
            'automatic_jumplists': ('LNK/JL', 'LNK_table', None, 'id', ['Source_Name', 'Local_Path', 'Common_Path', 'Relative_Path', 'AppID', 'DestList_Checksum']),
            'custom_jumplists': ('LNK/JL', 'AJL_table', None, 'id', ['Source_Name', 'Local_Path_Ext', 'CLI_Arguments', 'Category']),
            'AJL_table': ('LNK/JL', 'AJL_table', None, 'id', ['file_name', 'app_id']),
            'Clj_table': ('LNK/JL', 'Clj_table', None, 'id', ['file_name', 'destination_list']),
            'bam_entries': ('BAM/DAM', 'Bam_table', None, 'id', ['executable_path', 'execution_time', 'process_path']),
            'dam_entries': ('BAM/DAM', 'Dam_table', None, 'id', ['executable_path', 'execution_time', 'process_path']),
            ...
            'userassist_entries': ('UserAssist', 'UserAssist_table', None, 'id', ['program_name', 'execution_count', 'program_path']),
            ...
            'recent_docs': ('File Activity', 'RecentDocs_table', None, 'id', ['file_name', 'extension', 'mru_position', 'file_path']),
            ...
            'machine_run_once': ('System Info', 'MachineRunOnce_table', None, 'id', ['key_path', 'value_name', 'value_data']),
            'MachineRunOnce_table': ('System Info', 'MachineRunOnce_table', None, 'id', ['key_path', 'value_name']),
