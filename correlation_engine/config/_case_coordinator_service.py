...
class CaseConfigurationManager:
    ...
    # NOTE: an earlier definition of `set_live_acquisition_path` was removed here. Python keeps
    # the last one, so it never ran.
    
    # NOTE: an earlier definition of `create_live_acquisition_directory` was removed here. Python keeps
    # the last one, so it never ran.
    
    # NOTE: an earlier definition of `_validate_directory_path` was removed here. Python keeps
    # the last one, so it never ran.
