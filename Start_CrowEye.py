...
# Form implementation generated from reading ui file 'Crow Eye v11.ui'
#
...
"")
        ...
        self.loadData = QtWidgets.QPushButton(self.side_fram)
        self.loadData.setStyleSheet("QPushButton {\n"
"   \n"
...
"")
        ...
        self.verticalLayout_3.addWidget(self.loadData)
...
"")
        ...
        self.filesActivityTab_tables.setCurrentIndex(6)
        ...
        self.registrybutton.clicked.connect(parse_registry)
        self.logbutton.clicked.connect(parse_logs)
        self.Prefetchbutton.clicked.connect(parse_perfetch)
        self.loadData.clicked.connect(load_all_data)    
    ...
    def retranslateUi(self, Crow_Eye):
        ...
        self.loadData.setText(_translate("Crow_Eye", "Load Data"))
        self.label_2.setText(_translate("Crow_Eye", "Parsing files"))
